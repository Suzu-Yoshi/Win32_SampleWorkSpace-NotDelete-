...
VOID MY_DRAW(HDC hdc)
{
	...
	//無限カウントを入れる変数
	TCHAR Str_Mugen_Cnt[64];

	//無限カウントの座標を整形
	wsprintf(Str_Mugen_Cnt, TEXT("カウント：%06d"), mugen_cnt);

	//無限カウントの座標を描画
	TextOut(hdc, 100, tm.tmHeight * 2, Str_Mugen_Cnt, lstrlen(Str_Mugen_Cnt));
